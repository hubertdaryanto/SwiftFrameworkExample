Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/hubertdaryanto/SwiftFrameworkExample"
  ...
  spec.source       = { :git => "https://github.com/hubertdaryanto/SwiftFrameworkExample.git", :tag => "#{spec.version}" }
